...
const emit = defineEmits(['close', 'submit', 'file-change', 'manual-change', 'autocad-change', 'hover-change', 'portada-change', 'icono-change', 'toggle-password', 'open-manual' , 'open-autocad']);
                            ...
                            <div v-for="column in columns" :key="column" class="py-3">
                                ...
                                <template v-else-if="column === 'hover'">
                                    ...
                                    <div class="relative w-full">
                                        ...
                                        <input type="file" :id="`edit_${column}`"
                                            @change="$emit('hover-change', $event)" class="hidden">
                                        <p class="text-xs text-gray-400 mt-1">
                                            Formatos permitidos: JPEG, PNG, JPG, SVG, WEBP.<br>
                                ...
                                <template v-else-if="column === 'icono'">
                                    ...
                                    <div class="relative w-full">
                                        ...
                                        <input type="file" :id="`edit_${column}`"
                                            @change="$emit('icono-change', $event)" class="hidden">
                                        <p class="text-xs text-gray-400 mt-1">
                                            Formatos permitidos: JPEG, PNG, JPG, SVG, WEBP.<br>
                                ...
                                <template v-else-if="column === 'manual'">
                                    <label :for="`edit_${column}`" class="block font-medium text-gray-700 mb-1">Manual (Opcional)</label>
                                    <div class="relative w-full">
                                        <label :for="`edit_${column}`"
                                            class="block border border-main-color rounded-md bg-white px-4 py-2 w-full text-gray-600 cursor-pointer text-center">
                                            {{ manualInputLabel }}
                                        ...
                                        <input type="file" :id="`edit_${column}`"
                                            @change="$emit('manual-change', $event)" accept="application/pdf"
                                            class="hidden">
                                    </div>
                                    <p class="text-xs text-gray-500 mt-1">Formatos permitidos: .pdf .doc .docx - Máximo 5MB</p>
                                    <div v-if="formData.manual && typeof formData.manual === 'string'"
                                        class="mt-2">
                                ...
                                <template v-else-if="column === 'autocad'">
                                    <label :for="`edit_${column}`" class="block font-medium text-gray-700 mb-1">Autocad (Opcional)</label>
                                    <div class="relative w-full">
                                        <label :for="`edit_${column}`"
                                            class="block border border-main-color rounded-md bg-white px-4 py-2 w-full text-gray-600 cursor-pointer text-center">
                                            {{ autocadInputLabel }}
                                        ...
                                        <input type="file" :id="`edit_${column}`"
                                            @change="$emit('autocad-change', $event)" accept="application/pdf"
                                            class="hidden">
                                    </div>
                                    <p class="text-xs text-gray-500 mt-1">Formatos permitidos: .pdf .dwg .dxf - Máximo 15MB</p>
                                    <div v-if="formData.autocad && typeof formData.autocad === 'string'"
                                        class="mt-2">
                                        <p class="block text-gray-700">Autocad actual:</p>
                                        <div class="flex items-center gap-2 mt-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-red-500"
                                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            <button @click="$emit('open-autocad', formData.autocad)" type="button"
                                                class="text-blue-500 hover:underline text-sm">
                                                Ver Autocad actual
                                            </button>
                                        </div>
