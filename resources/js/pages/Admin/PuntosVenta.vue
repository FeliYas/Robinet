...
const columns = ['orden', 'titulo', 'direccion', 'telefono', 'sitio_web', 'latitud', 'longitud'];

// Definición de rutas
const createRoute = route('puntos.store');
const updateRoute = (id) => route('puntos.update', { id });
const deleteRoute = (id) => route('puntos.destroy', { id });
...
<template>
    <div>
        ...
        <DataTable :columns="columns" :data="puntos" :createRoute="createRoute" :updateRoute="updateRoute"
